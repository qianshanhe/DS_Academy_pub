...
This workspace is prepared to be opened as a local Git repository in GitHub Desktop.
...
Publishing the whole repository as public exposes learning logs, notes, and roadmap files. The `/docs` folder contains only the quiz web app, but public repository visibility still makes the rest of the repository readable on GitHub.
